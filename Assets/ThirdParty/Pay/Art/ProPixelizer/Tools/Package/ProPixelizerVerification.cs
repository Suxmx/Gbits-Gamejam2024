...
namespace ProPixelizer
{
    ...
    public class ProPixelizerVerification
    {
        ...
        {
#if UNITY_EDITOR
            AssetDatabase.ImportAsset("Assets/ThirdParty/Pay/Art/ProPixelizer/ShaderGraph/ProPixelizerBase.shadergraph", ImportAssetOptions.ForceUpdate);
            AssetDatabase.ImportAsset("Assets/ThirdParty/Pay/Art/ProPixelizer/SRP/PixelizedWithOutline.shader", ImportAssetOptions.ForceUpdate);
#endif
        }
